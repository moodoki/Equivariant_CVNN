...
def get_available_pool_methods():
    return _available_pool_methods
...
def get_pool_method(name, FLAGS):
    ...
    pool_method = {
        ...
        "avgpool": partial(nn.AvgPool2d, kernel_size=FLAGS.pool_k),
        "skip": None,
    }
    return pool_method[name]


def get_unpool_method(
    unpool,
    pool_method,
    antialias_mode,
    antialias_size,
    antialias_padding,
    antialias_padding_mode,
    antialias_group,
    antialias_scale,
    get_samples,
    LPS_u_convex=False,
...
def get_available_antialias():
    return _available_antialias
